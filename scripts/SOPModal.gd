...
var sop_database: Array = [
	...
	},
	{
		...
		"tags": ["service", "center", "workshop", "yellow", "magnum", "labadis", "bikes", "deepest", "first"],
		"content": "[font_size=28][color=#0082c3][b]Service Center (Workshop)[/b][/color][/font_size]\n\nService Center pallets (shown in [color=#f1c40f]yellow[/color]) contain Regional Workshop items: small magnums (grey containers on a blue pallet base with a green label) and bikes on Labadis stands.\n\n[b]What they look like:[/b]\n\n[b]Workshop magnum:[/b] Grey container on blue pallet base, green label.\n[img=350]res://ui/images/sc_magnum_photo.png[/img]\n\n[b]Bike on Labadis stand:[/b] Individual bike secured on a wheeled Labadis frame.\n[img=350]res://ui/images/sc_bike_stand_photo.png[/img]\n\n[b]Why they load first (deepest in the truck):[/b]\nWorkshop items go to the store workshop on their own schedule. Loading them deepest means they come off last — the workshop team collects them separately from the main store unload.\n\n[b]They are never overdue:[/b]\nService Center pallets always carry a [b]D[/b] promise. They are not part of D-/D+ priority decisions.\n\n[b]How to spot them:[/b]\nYellow colour in the simulator. Sector 86 in the RAQ. UAT prefix 0035 (EWM format, different from standard 8486 mecha codes).\n\n[b]Important:[/b] Never leave a Service Center pallet behind. It is not a critical fail like C&C, but stores depend on workshop items arriving on schedule.",
		"scenarios": [0, 1, 2, 3],
		"new_in": 0
	},
	{
	...
	},
	{
		...
		"content": "[font_size=28][color=#0082c3][b]Reading the Loading Plan[/b][/color][/font_size]\n\nThe Loading Plan is your shift schedule. It tells you what is coming and when. In this simulator it is displayed on the [b]Office[/b] panel.\n\n[b]It shows:[/b]\nWhich stores, at what time. CO (shared truck) or SOLO. Which carrier (DHL, SCHOTPOORT, P&M). Truck size (8.5m or 13.6m). Live or non-live loading.\n\nYour load is highlighted in yellow. The others give context for pacing your shift.\n\nFor co-loading, the Office also shows [b]seal numbers[/b] for each sequence. You will need to enter these on the SAISIE screen.\n\n[b]Emballage section:[/b]\nThe Office lists non-live emballage from the night shift. These are empty pallets still inside the truck that must be cleared before you can start loading. The number shown tells you how many to remove. Each removal takes about 45 seconds.\n\n[b]Three documents, three moments:[/b]\n[b]Loading Plan / Office[/b] — what is scheduled (read before the shift)\n[b]Loading Sheet[/b] — what you physically count (fill during loading)\n[b]CMR[/b] — what you legally certify (sign after loading)",
		"scenarios": [1, 2, 3],
		"new_in": 1
	},
	{
	...
	},
	{
		...
		"content": "[font_size=28][color=#0082c3][b]Good Practices: Thinking Like an Operator[/b][/color][/font_size]\n\nThe difference between loading correctly and loading well is timing and anticipation. These practices are not rules — they are habits that experienced operators develop because they reduce pressure and make better use of the time available.\n\n[b]Read before you load[/b]\nOpen the RAQ before clicking Start Loading. Look at what you have: how many pallets, any ADR, any TRANSIT rows. Check the Office for your store code and any notes. One minute of reading saves five minutes of correcting. You cannot unseal a truck.\n\n[b]Call departments before you start — not after[/b]\nIf a C&C pallet is missing from the dock, click Call Departments before you click Start Loading. Calling before loading costs you nothing — that time is not counted against your loading window. Calling after Start Loading adds five minutes to your shift clock. Same action, very different cost depending on when you do it.\n\n[b]Leave combine-eligible pallets for last[/b]\nWhen you see a small, light pallet on the dock (marked with a green [color=#2ecc71]⊕[/color] border), do not rush to load it in strict sequence order. Load the big, heavy pallets first. Keep the light ones near the back of your loading order. Here is why: if a wave arrives later and the truck is suddenly full, those light pallets become your solution — you can combine two of them into one slot and free up space for the incoming priority pallet. If you had already loaded them early, that option is gone. Combining costs 8 minutes but it is worth it if it gets a D- pallet onto the truck.\n\n[b]Do not combine if the truck is not full[/b]\nCombining always costs time. If everything fits without combining, skip it. The deckstacker is a problem-solving tool, not a routine step. The right time to combine is when you are looking at a full truck and a D- pallet still on the dock — not before.\n\n[b]Watch the phone early, not late[/b]\nWhen the phone flashes, open it immediately. The message tells you what is coming and approximately when. If a D- pallet is on its way, you now have time to hold space for it before the truck fills up. If you ignore the phone until the truck is already full, your options become much harder.\n\n[b]Know the difference between waiting and stalling[/b]\nIf a D- wave is confirmed incoming and the truck still has space, wait — there is no cost to holding off on the last few D+ pallets. But if the truck is full of D and D- pallets and only D+ is left on the dock, seal it. Leaving D+ behind while all D and D- are loaded is correct. Do not chase perfection if the truck is already right.\n\n[b]Validate in the AS400 as soon as loading is done[/b]\nDo not wait until the driver is standing at the dock before confirming the RAQ. Confirm it the moment you finish loading — before you think about paperwork or the seal. The confirmation creates the digital record the store relies on. Sealing the truck without confirming means the store receives a truck with no AS400 record of what is on it.\n\n[b]Check the transit rack before you seal, not before you start[/b]\nTransit rack items are added to your RAQ from the start but are not on the dock yet. You do not need to collect them before loading — you can load everything else first and collect transit items at any point before sealing. The cost is 4 minutes. Do not forget: check the RAQ for TRANSIT rows before you click Seal Truck.\n\n[b]For co-loading: treat each store as its own shift[/b]\nThe cleanest mental model for co-loading is to pretend you are doing two separate loadings back to back. Finish Store 1 completely — load, validate in AS400, confirm — then start Store 2 as if it were a fresh shift. Never mix pallets between stores. The physical divider in the truck and the AS400 both enforce this.",
		"scenarios": [1, 2, 3],
		"new_in": 1
	},
	{
		"title": "Paperwork: Three Documents, Three Moments",
		"tags": ["paperwork", "document", "cmr", "loading", "sheet", "plan", "process", "sign", "paper", "office"],
		"content": "[font_size=28][color=#0082c3][b]Paperwork: Three Documents, Three Moments[/b][/color][/font_size]\n\nThree documents guide a single loading. Each serves a different purpose and is used at a different moment.\n\n[b]1. Loading Plan / Office — Before the shift[/b]\nThe Loading Plan tells you what is scheduled: which stores, what times, solo or co-loading, which carrier, truck size. Read it in the office before walking to the dock. In the simulator, this is the Office panel. It also shows emballage to clear and emergency contacts.\n\n[b]2. Loading Sheet — During loading[/b]\nThe Loading Sheet is a paper form (or the Loading Sheet panel in the simulator). It tracks pallet counts live: EUR pallets, Plastic pallets, Magnums, C&C, and department breakdowns (Bikes, Bulky, Mecha). Fill it as you load — do not rely on memory. The numbers from this sheet feed directly into the CMR.\n\n[b]3. CMR — After loading[/b]\nThe CMR (Convention Marchandise Routière) is the legal transport document. It records who sent the goods, where they are going, what is on the truck, and how much it weighs. You and the driver both sign it. If there is a discrepancy at the store, the CMR is the document everyone looks at.\n\n[b]The sequence:[/b]\n1. Read the Loading Plan (office, before loading)\n2. Fill the Loading Sheet (dock, during loading)\n3. Complete the CMR (dock, after loading, before the driver leaves)\n4. Seal the truck\n\n[b]In the simulator:[/b] The Loading Sheet and CMR panels update automatically as you load pallets. Review both before sealing — the debrief checks whether you opened them.",
		"scenarios": [1, 2, 3],
		"new_in": 1
	},
	{
		"title": "Step-by-Step: Filling the Loading Sheet",
		"tags": ["loading", "sheet", "step", "fill", "how", "guide", "store", "seal", "dock", "count", "eur", "plastic", "magnum", "expedition", "paperwork"],
		"content": "[font_size=28][color=#0082c3][b]Step-by-Step: Filling the Loading Sheet[/b][/color][/font_size]\n\nThe Loading Sheet is your operational counting record. It is the single source of truth for what is on the truck — every number on the CMR comes from this sheet. Here is exactly how and when to fill each field.\n\n[font_size=18][color=#f1c40f][b]BEFORE LOADING (Office — Pre-Load Fields)[/b][/color][/font_size]\n\nThese fields are filled from the Loading Plan board in the office, before you walk to the dock.\n\n[color=#ff9900][b]Store[/b][/color] — The store name or code you are loading for. Find it on the Loading Plan board (left side of the office). Example: ALKMAAR or 1570. [color=#a0a4aa]Why: Identifies which truck this sheet belongs to. If sheets get mixed up, the wrong counts go to the wrong CMR.[/color]\n\n[color=#2ecc71][b]Seal Number[/b][/color] — The physical seal number printed on the plastic strip you collected from the desk. Example: DK02451. [color=#a0a4aa]Why: Links this paperwork to the physical seal on the truck. If the seal number does not match at the store, the delivery is rejected.[/color]\n\n[color=#0082c3][b]Dock Number[/b][/color] — Your assigned dock bay number, from the Loading Plan board. Example: 7. [color=#a0a4aa]Why: The office needs to know which dock was used for this loading — it is how they track which truck is where.[/color]\n\n[font_size=18][color=#f1c40f][b]DURING LOADING (Dock — Auto-Filled)[/b][/color][/font_size]\n\nIn the simulator, the pallet grid on the Loading Sheet updates automatically as you load pallets. In real life, you tally each pallet with a mark as you scan and load it.\n\nThe left side tracks [b]by department[/b] (Bikes, Bulky, Mecha, Transit, C&C). The right side tracks [b]by container type[/b] (EUR wooden pallet, Plastic pallet, Magnum). The same pallet appears on both sides.\n\n[font_size=18][color=#f1c40f][b]AFTER LOADING (Dock — Count Fields)[/b][/color][/font_size]\n\nAfter all pallets are loaded, fill in these summary fields. The auto-count row above the input fields shows the correct values.\n\n[color=#e74c3c][b]UATs[/b][/color] — Total number of UAT (transport unit) labels. Each pallet has one UAT sticker. [color=#a0a4aa]Why: UAT count = pallet count. It is a cross-check: if you loaded 12 pallets, you should have 12 UATs.[/color]\n\n[color=#e74c3c][b]Collis[/b][/color] — Total number of individual packages (boxes). A single EUR pallet might carry 40 boxes. [color=#a0a4aa]Why: Collis count tells the store how many boxes to expect. If they receive fewer, they know something is missing.[/color]\n\n[color=#e74c3c][b]EUR[/b][/color] — Number of EUR wooden pallets (standard 80x120 cm). [color=#a0a4aa]Why: EUR pallets are exchange pallets — the store returns empties. The count must match.[/color]\n\n[color=#e74c3c][b]Plastic[/b][/color] — Number of plastic pallets. [color=#a0a4aa]Why: Plastic pallets are also tracked for return logistics.[/color]\n\n[color=#e74c3c][b]Magnum[/b][/color] — Number of magnum roll containers. [color=#a0a4aa]Why: Magnums are tall wheeled containers. They take more truck space and must be counted separately for capacity planning.[/color]\n\n[color=#e74c3c][b]C&C[/b][/color] — Number of Click & Collect pallets. [color=#a0a4aa]Why: C&C pallets are customer orders. Missing one means a customer does not get their order.[/color]\n\n[color=#e74c3c][b]Expedition Number[/b][/color] — The number the AS400 assigned when you registered the shipment. Find it at the top of the SAISIE screen after pressing F10 (N°exp(dition field). [color=#a0a4aa]Why: Links the physical loading to the digital record in the warehouse system. Without it, the system does not know this truck left.[/color]\n\n[b]Golden rule:[/b] If the auto-count and your manual count disagree, recount. Never copy numbers you are not sure about.",
		"scenarios": [0, 1, 2, 3],
		"new_in": 0
	},
	{
		"title": "Step-by-Step: Filling the CMR",
		"tags": ["cmr", "step", "fill", "how", "guide", "stamp", "sign", "seal", "weight", "volume", "expedition", "franco", "driver", "paperwork", "transport"],
		"content": "[font_size=28][color=#0082c3][b]Step-by-Step: Filling the CMR[/b][/color][/font_size]\n\nThe CMR (Convention relative au contrat de transport international de Marchandises par Route) is the legal transport document. It proves what was loaded, by whom, for which destination, and under what conditions. Both you and the driver sign it. If there is ever a dispute about a delivery, the CMR is the document everyone refers to.\n\n[font_size=18][color=#f1c40f][b]BEFORE LOADING (Office — Stamp & Initial Fields)[/b][/color][/font_size]\n\nWhen you first open the CMR in the office, do these things:\n\n[color=#0082c3][b]Stamp — Top Section (Box 22)[/b][/color] — Press the Decathlon sender stamp. This stamps the company name and address. [color=#a0a4aa]Why: Legally identifies who is sending the goods. Without it, the CMR is incomplete.[/color]\n\n[color=#0082c3][b]Franco / Non-Franco[/b][/color] — Select whether this is a franco delivery. Franco means transport cost is included in the goods price (Decathlon pays). Non-Franco means the receiving store pays. Most Decathlon-to-store deliveries are [b]Franco[/b]. [color=#a0a4aa]Why: Determines who is responsible for transport costs. Wrong selection can cause billing disputes.[/color]\n\n[font_size=18][color=#f1c40f][b]AFTER LOADING (Office — Completion Fields)[/b][/color][/font_size]\n\nAfter all pallets are loaded and you have confirmed in the AS400 (F10), fill these fields:\n\n[color=#e74c3c][b]Counts (UATs, Collis, EUR, Plastic, Magnum, C&C)[/b][/color] — Copy these directly from your Loading Sheet. Do not guess or remember — transfer the exact numbers. [color=#a0a4aa]Why: These counts are the legal declaration of what is on the truck. The store will compare against what they receive.[/color]\n\n[color=#e74c3c][b]Weight (kg)[/b][/color] — The total weight in kilograms. Find this on the AS400 confirmation screen after pressing F10 (the Validation Effectuée screen). [color=#a0a4aa]Why: Legal transport requirement. Overweight trucks are a road safety and legal violation.[/color]\n\n[color=#e74c3c][b]Volume (dm³)[/b][/color] — The total volume in cubic decimeters. Also from the AS400 confirmation screen. [color=#a0a4aa]Why: Volume determines how full the truck is and affects transport cost calculations.[/color]\n\n[color=#e74c3c][b]Expedition Number[/b][/color] — The number assigned by the AS400 when you created the shipment (N°exp(dition field). Same number as on your Loading Sheet. [color=#a0a4aa]Why: Cross-references the physical CMR to the digital warehouse record. Essential for tracking.[/color]\n\n[color=#e74c3c][b]Seal Number[/b][/color] — The physical seal number. Same as on your Loading Sheet. [color=#a0a4aa]Why: Proves the truck was not opened between loading and delivery. If the seal is broken on arrival, the store documents it.[/color]\n\n[color=#e74c3c][b]Dock Number[/b][/color] — Your dock bay number. [color=#a0a4aa]Why: Traceability — if there is a problem, the office can identify where the loading happened.[/color]\n\n[font_size=18][color=#f1c40f][b]WRAPUP (Office — Handoff)[/b][/color][/font_size]\n\n[color=#2ecc71][b]Hand CMR to Driver[/b][/color] — Give the CMR to the driver. The driver fills in their licence plate number and signs (Box 23). They keep one copy, you keep one. [color=#a0a4aa]Why: The driver's signature confirms they received the goods in the stated condition. Both parties have a signed copy for legal protection.[/color]\n\n[color=#2ecc71][b]Archive[/b][/color] — Your copy of the signed CMR is stapled on top of the Loading Sheet and filed in the office locker. [color=#a0a4aa]Why: If the store reports a discrepancy, the office pulls this file to verify what was actually loaded.[/color]\n\n[b]Key principle:[/b] The CMR is not busywork — it is the single document that protects you, the store, the driver, and Decathlon if anything goes wrong during transport.",
		"scenarios": [0, 1, 2, 3],
		"new_in": 0
	}
]
...
func _build_sop_modal() -> void:
	...
	UIStyles.apply_panel(pnl, UIStyles.flat(Color(0.95, 0.95, 0.95, 1), 8))
	center.add_child(pnl)

	var main_vbox: VBoxContainer = VBoxContainer.new()
	pnl.add_child(main_vbox)
	
	var header_bg: ColorRect = ColorRect.new()
	...
	title.add_theme_font_size_override("font_size", UITokens.fs(24))
	...
	for ti: int in range(2):
		...
		var tb_active := UIStyles.flat(UITokens.COLOR_ACCENT_BLUE, 4)
		var tb_inactive := UIStyles.flat(UITokens.CLR_TAB_INACTIVE, 4)
	...
	btn_close.add_theme_stylebox_override("normal", UIStyles.flat(UITokens.CLR_RED_DIM, 4))
	btn_close.add_theme_stylebox_override("hover", UIStyles.flat(Color(0.9, 0.25, 0.25), 4))
	...
	var close_margin: MarginContainer = MarginContainer.new()
	...
	var left_pnl: PanelContainer = PanelContainer.new()
	left_pnl.custom_minimum_size = Vector2(400, 0)
	UIStyles.apply_panel(left_pnl, UIStyles.flat(Color(0.9, 0.9, 0.9)))
	...
	var scroll_res: ScrollContainer = ScrollContainer.new()
...
func _refresh_sop_tab_styles() -> void:
	for i: int in range(tab_btns.size()):
		...
		var tb_sb := UIStyles.flat(UITokens.COLOR_ACCENT_BLUE if is_active else UITokens.CLR_TAB_INACTIVE, 4)
		tb.add_theme_stylebox_override("normal", tb_sb)

func _open_sop_modal() -> void:
	if _ui._session != null: _ui._session.set_pause_state(true)
	active_tab = 1
	_refresh_sop_tab_styles()
	search_input.text = ""
	content_label.text = "[color=#95a5a6]" + Locale.t("sop.select_article") + "[/color]"
...
func _close_sop_modal() -> void:
	if _ui._session != null: _ui._session.set_pause_state(false) 
	overlay.visible = false


func open_to_article(title: String) -> void:
	## Opens the SOP modal and auto-displays the article with the given title.
	if _ui._session != null: _ui._session.set_pause_state(true)
	active_tab = 1
	_refresh_sop_tab_styles()
	search_input.text = ""
	...
	for article: Dictionary in Locale.get_sop_database():
		if article.get("_en_title", "") == title or article.get("title", "") == title:
			content_label.text = article.get("content", "")
			content_label.get_v_scroll_bar().value = 0
			break

func _on_sop_search_changed(query: String) -> void:
	for child: Node in results_vbox.get_children():
		child.queue_free()
	...
	for article: Dictionary in Locale.get_sop_database():
		# Free Play (index 4) shows all articles — no scenario filter
		if _ui._current_scenario_index != 4 and not article.scenarios.has(_ui._current_scenario_index):
			continue

		var en_title: String = article.get("_en_title", article.get("title", ""))
		var in_tab1: bool = en_title in tab1_titles
	...
	var create_btn: Callable = func(art: Dictionary, is_new: bool) -> void:
		...
		var n_bg: Color = Color(1.0, 0.98, 0.8) if is_new else Color.WHITE
		var btn_sb := UIStyles.flat(n_bg)
		btn_sb.border_width_bottom = 1
		btn_sb.border_color = Color(0.8, 0.8, 0.8)
		var btn_hover := UIStyles.flat(Color(0.9, 0.95, 1.0))
		btn_hover.border_width_bottom = 1
		btn_hover.border_color = Color(0.8, 0.8, 0.8)
		
		btn.add_theme_stylebox_override("normal", btn_sb)
		btn.add_theme_stylebox_override("hover", btn_hover)
		btn.add_theme_stylebox_override("focus", StyleBoxEmpty.new())
		
		var t_color: Color = Color(0.7, 0.4, 0.0) if is_new else Color(0.2, 0.2, 0.2)
